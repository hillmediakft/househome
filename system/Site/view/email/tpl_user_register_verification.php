                            ...
                            <tr>
                                <td style="box-sizing: border-box; padding: 20px;">
                                    <table border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td>
                                                <p style="color: #666; font-size: 16px; font-weight: 700">Kedves {user_name}!</p>

											    <p>Sikeresen regisztráltál a {base_url} című oldalunkra.</p>
											    
											    <p>Regisztrációd jelenleg passzív.</p>
											    
											    <a style="color:blue;" href="{base_url}felhasznalo/ellenorzes/{user_id}/{user_activation_hash}">Klikkelj erre a linkre a regisztraciód aktiválásához!</a>
